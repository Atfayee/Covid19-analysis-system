    ...
    mapTime: {
      baseOption: {
        ...
        visualMap: {
          ...
          showLabel: true,
          pieces: [
            { min: 0, max: 15, color: '#38a800' },
            { min: 16, max: 70, color: '#5aba00' },
            { min: 71, max: 267, color: '#83cf00' },
            { min: 268, max: 976, color: '#b0e000' },
            { min: 977, max: 3522, color: '#e4f500' },
            { min: 3523, max: 12671, color: '#ffe100' },
            { min: 12672, max: 45553, color: '#ffaa00' },
            { min: 45554, max: 163723, color: '#ff7300' },
            { min: 163724, max: 588406, color: '#ff3700' },
            { min: 588407, max: 2114638, color: '#ff0000' },

...
export class temperatureService {
    ...
    temperatureData = [
        ...
        { name: "湖南省", value: 18 },
        { name: "广东省", value: 22.8 },
        { name: "广西壮族自治区", value: 21.2 },
        { name: "海南省", value: 25.4 },
        { name: "重庆市", value: 17.2 },
        { name: "四川省", value: 15.4 },
        { name: "贵州省", value: 16 },
        { name: "云南省", value: 17.6 },
        { name: "西藏自治区", value: 5.4 },
        { name: "陕西省", value: 12.51 },
        { name: "甘肃省", value: 8.8 },
        { name: "青海省", value: 3.96 },
        { name: "宁夏回族自治区", value: 9.36 },
        { name: "新疆维吾尔自治区", value: 8.95 },
    ];
    ...
    // 柱状体的顶部
    scatterData() {
        return this.temperatureData.map((item) => {
